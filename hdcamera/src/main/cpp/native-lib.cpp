...
void *connect(void *args) {
    ...
    do {
        ...
        //开启输出模式， 播放拉流不需要推流，就可以不开  发布流的时候必须要使用。如果不使用则代表接收流。
...
Java_com_hd_hdcamera_rtmp_RtmpClient_connect(JNIEnv *env, jobject thiz, jstring url_) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_hd_hdcamera_rtmp_RtmpClient_nativeInit(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_hd_hdcamera_rtmp_RtmpClient_nativeConfig(JNIEnv *env, jobject thiz,
                                                  jboolean is_hard_encoder) {

}

extern "C"
JNIEXPORT void JNICALL
Java_com_hd_hdcamera_rtmp_RtmpClient_disConnect(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_hd_hdcamera_rtmp_RtmpClient_initVideoEnc(JNIEnv *env, jobject thiz, jint width,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_hd_hdcamera_rtmp_RtmpClient_releaseVideoEnc(JNIEnv *env, jobject thiz) {
    if (videoChannel) {
        delete (videoChannel);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_hd_hdcamera_rtmp_RtmpClient_nativeDeInit(JNIEnv *env, jobject thiz) {
    if (helper) {
        delete (helper);
        helper = nullptr;
    }
...
extern "C"
JNIEXPORT void JNICALL
Java_com_hd_hdcamera_rtmp_RtmpClient_nativeSendVideo(JNIEnv *env, jobject thiz,
                                                                 jbyteArray buffer) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_hd_hdcamera_rtmp_RtmpClient_releaseAudioEnc(JNIEnv *env, jobject thiz) {
    if (audioChannel) {
        delete (audioChannel);
        audioChannel = 0;
    }
