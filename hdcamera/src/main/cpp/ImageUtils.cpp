...
Java_com_hd_hdcamera_rtmp_ImageUtils_rotation(JNIEnv *env, jclass thiz, jbyteArray data_, jint width,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_hd_hdcamera_rtmp_ImageUtils_scale(JNIEnv *env, jclass clazz, jbyteArray src_, jbyteArray dst_,
                                       jint srcWidth,
